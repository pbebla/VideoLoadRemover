...
CreateHwndRenderTarget(
    ...
    winrt::check_hresult(adapter->GetParent(winrt::guid_of<ID2D1Factory>(), factory.put_void()));

    D2D1_RENDER_TARGET_PROPERTIES prop;
    prop.type = D2D1_RENDER_TARGET_TYPE_DEFAULT;
    //prop.pixelFormat = PixelFormat(DXGI_FORMAT_B8G8R8A8_UNORM, 0);

    //winrt::check_hresult(factory->CreateHwndRenderTarget())
